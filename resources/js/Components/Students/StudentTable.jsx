    ...
    /**
     * Komponen utama untuk menampilkan data siswa dalam bentuk tabel
     * dengan fitur sorting, pagination, dan desain responsif tanpa scroll horizontal.
     */
    export default function StudentTable({ data = [], onDelete, onEdit, onAdd }) {
    ...
    const headers = [
        { label: "ID", key: "id", maxWidth: "80px", className: "font-mono text-xs" },
        { label: "NISN", key: "nisin", maxWidth: "120px" },
        { label: "Nama Lengkap", key: "nama_lengkap", maxWidth: "150px", className: "font-semibold" },
        { label: "Jurusan", key: "jurusan", maxWidth: "120px" },
        { label: "Angkatan", key: "angkatan", maxWidth: "120px" },
        { label: "No HP", key: "no_hp", maxWidth: "130px" },
        { label: "Alamat", key: "alamat", maxWidth: "250px" },
    ...
    return (
        ...
        <div className="flex justify-between items-center mb-6 flex-wrap gap-4">
            <h2 className="text-2xl font-extrabold text-gray-800">Data Siswa</h2>
            <button
            onClick={onAdd}
        ...
        <div className="overflow-x-auto md:overflow-x-hidden w-full bg-white rounded-xl shadow-lg border border-gray-200">
            ...
            <tbody className="divide-y divide-gray-200 text-sm">
                ...
                currentData.map((s, index) => (
                    <tr key={s.id || index} className="hover:bg-gray-50 transition-colors align-top">
                    ...
                    {headers.map((h) => {
                        ...
                        <td
                            key={h.key}
                            className={`px-4 py-3 break-words ${h.className || ""}`}
                            style={{ maxWidth: h.maxWidth || "150px" }}
                        >
                            {s[h.key] ?? "-"}
                        </td>
                        );
                ...
                <tr>
                    ...
                    <p className="text-lg font-medium">Data Siswa Tidak Ditemukan</p>
