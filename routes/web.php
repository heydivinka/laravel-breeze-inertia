...
| Peminjaman Routes
|--------------------------------------------------------------------------
| Pastikan route statis ditempatkan di atas route dengan parameter {id}
*/

// Daftar peminjaman
Route::get('/peminjaman', [PeminjamanController::class, 'index'])->name('peminjaman.index');

// Tambah peminjaman → gunakan Pages/PeminjamanAdd.jsx
Route::get('/peminjaman/add', fn() => Inertia::render('Peminjaman/PeminjamanAdd'))->name('peminjaman.add');
